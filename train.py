...
for i in range(-1, 9):
    ...
    if test_folder_index == 0:
        if precision_recall_fscore_support(true_label_triple_onetest_macro, decision_triple_onetest_macro, average='binary')[2] > precision_recall_fscore_support(true_label_triple_onetest_biased, decision_triple_onetest_biased, average='binary')[2]:
            decision_triple_alltests = decision_triple_onetest_macro
            true_label_triple_alltests = true_label_triple_onetest_macro
        else:
            decision_triple_alltests = decision_triple_onetest_biased
            true_label_triple_alltests = true_label_triple_onetest_biased
    else:
        if precision_recall_fscore_support(true_label_triple_onetest_macro, decision_triple_onetest_macro, average='binary')[2] > precision_recall_fscore_support(true_label_triple_onetest_biased, decision_triple_onetest_biased, average='binary')[2]:
            decision_triple_alltests = np.concatenate((decision_triple_alltests, decision_triple_onetest_macro), axis = 0)
            true_label_triple_alltests = np.concatenate((true_label_triple_alltests, true_label_triple_onetest_macro), axis=0)
        else:
            decision_triple_alltests = np.concatenate((decision_triple_alltests, decision_triple_onetest_biased), axis=0)
            true_label_triple_alltests = np.concatenate((true_label_triple_alltests, true_label_triple_onetest_biased), axis=0)


print("======== Results on all test folders ========")
print("MACRO: ", precision_recall_fscore_support(true_label_triple_alltests, decision_triple_alltests, average='macro'))
print("BIASED: ", precision_recall_fscore_support(true_label_triple_alltests, decision_triple_alltests, average='binary'))
print("Classification Report \n", classification_report(true_label_triple_alltests, decision_triple_alltests, digits = 4))
print("Confusion Matrix \n", confusion_matrix(true_label_triple_alltests, decision_triple_alltests))
